...
public class FbDialog extends Dialog{
	...
	private class FbWebViewClient extends WebViewClient {
		...
		public boolean shouldOverrideUrlLoading(WebView view, String url) {
			FbUtil.logd("Facebook-WebView", "Redirect URL: " + url);
			if (url.startsWith(AppConstant.REDIRECT_URI)) {
				...
				if (error == null) {
					...
					mListener.onFacebookError(new FbError(error));
				}

				FbDialog.this.dismiss();
				return true;
			} else if (url.startsWith(AppConstant.CANCEL_URI)) {
				mListener.onCancel();
				FbDialog.this.dismiss();
				return true;
		...
		public void onReceivedError(WebView view, int errorCode,
			...
			mListener.onError(new FbDialogError(description, errorCode,
					failingUrl));
			FbDialog.this.dismiss();
		}
		...
		public void onPageStarted(WebView view, String url, Bitmap favicon) {
			FbUtil.logd("Facebook-WebView", "Webview loading URL: " + url);
