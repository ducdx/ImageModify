...
public final class FbUtil {
    ...
    public static String openUrl(String url, String method, Bundle params)
        ...
        FbUtil.logd("Facebook-Util", method + " URL: " + url);
     ...
     * @throws FbError - if an error condition is set
     */
    public static JSONObject parseJson(String response)
          throws JSONException, FbError {
        // Edge case: when sending a POST request to /[post_id]/likes
        // the return value is 'true' or 'false'. Unfortunately
        // these values cause the JSONObject constructor to throw
        // an exception.
        if (response.equals("false")) {
            throw new FbError("request failed");
        }
        ...
        if (json.has("error_code") && json.has("error_msg")) {
            throw new FbError(json.getString("error_msg"), "",
        ...
        if (json.has("error_reason")) {
            throw new FbError(json.getString("error_reason"));
        }
        return json;
    }
